...
import Form from "../../components/HeadFooter/Form";
import Table from "../../components/HeadFooter/Table";
import Filters from "../../components/HeadFooter/Filters";
import Pagination from "../../components/HeadFooter/Pagination";
...
export default function HeadFooter() {
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            const res = await fetch(`/api/Backend/HeadFooter/delete?id=${id}`, { method: "DELETE" });
