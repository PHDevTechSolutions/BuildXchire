...
import Form from "../../components/PostCategory/Form";
import Table from "../../components/PostCategory/Table";
import Filters from "../../components/PostCategory/Filters";
import Pagination from "../../components/PostCategory/Pagination";
...
export default function Categories() {
    ...
    const fetchCategory = async (refId: string) => {
        try {
            const res = await fetch(`/api/Backend/PostCategory/fetch?id=${refId}`);
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            const res = await fetch(`/api/Backend/PostCategory/delete?id=${id}`, { method: "DELETE" });
