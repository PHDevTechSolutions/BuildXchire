...
const Footer: React.FC<FooterProps> = ({systemStatus = "operational" }) => {
  ...
  return (
    <>
      ...
      <footer className="bg-lime-700 text-white py-4 w-full relative p-2">
        <div className="container mx-auto text-center text-xs px-4">
          <p className="font-bold">
            &copy; {new Date().getFullYear()} BuildXchire
            <span className="bg-lime-900 ml-2 px-2 py-1 rounded-md text-[10px]">Version 1.0</span>
          </p>
