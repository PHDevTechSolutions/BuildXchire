    ...
    <div className="flex flex-col items-center flex-grow overflow-y-auto text-xs p-2">
      <div className="w-full">
        <button
          ...
          className={`flex items-center w-full p-4 hover:bg-cyan-400 rounded hover:text-white transition-all duration-300 ease-in-out hover:shadow-md active:scale-95 ${collapsed ? "justify-center" : ""
            }`}
        >
            ...
            <div>
              {myProfileItem.subItems.map((subItem, subIndex) => (
                <Link
                  key={subIndex}
                  href={subItem.href}
                  className="flex items-center w-full p-4 bg-gray-200 hover:bg-cyan-400 hover:text-white transition-all duration-300 ease-in-out"
                >
            ...
            >
              {item.subItems.map((subItem, subIndex) => (
                <div key={subIndex} className="w-full">
                  <Link
                    href={subItem.href}
                    className="flex flex-col mb-1 p-4 bg-gray-200 hover:bg-cyan-400 hover:text-white transition-all duration-300 ease-in-out rounded"
                  >
