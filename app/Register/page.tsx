                    ...
                    {currentStep === 0 && (
                        <>
                            ...
                            <div>
                                ...
                                <select value={Location} onChange={(e) => setLocation(e.target.value)} className={`w-full px-4 py-2 bg-white border capitalize ${isDark ? "border-white/30 text-black" : "border-black/30 text-black"
                                    } text-xs rounded-md backdrop-blur-md focus:ring-2 focus:ring-cyan-400 outline-none transition duration-300 ease-in-out transform focus:scale-[1.01]`}
